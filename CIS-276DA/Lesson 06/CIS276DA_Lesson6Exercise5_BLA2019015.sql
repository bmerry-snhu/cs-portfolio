...
JOIN
    ap.invoice_line_items AS i ON g.account_number = i.account_number
JOIN
    ap.invoices AS inv ON i.invoice_id = inv.invoice_id
WHERE
    inv.invoice_date >= '2018-04-01' AND inv.invoice_date <= '2018-06-30'
GROUP BY
    g.account_description
HAVING
