...
namespace Lesson_12.Pages.Invoice
{
    public class EditModel : PageModel
    {
        ...
        public void OnGet(int id = 0)
        {
            ...
            DAL.Invoice invoice = _invoiceAdapater.GetInvoiceById(id);
            if(invoice != null)
            {
        ...
        public void SetupCustomerOptions()
        {
            ...
            IEnumerable<DAL.Customer> customers = _customerAdapater.GetAllCustomers();
            foreach(DAL.Customer customer in customers)
            {
