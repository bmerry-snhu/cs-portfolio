...
namespace BikeShop.Pages.Invoice
{
    public class EditModel : PageModel
    {
        ...
        public void OnGet(int id = 0)
        {
            ...
            BikeShop.DAL.Invoice invoice = _invoiceAdapater.GetInvoiceById(id);
            if(invoice != null)
            {
        ...
        public void SetupCustomerOptions()
        {
            ...
            IEnumerable<BikeShop.DAL.Customer> customers = _customerAdapater.GetAllCustomers();
            foreach(BikeShop.DAL.Customer customer in customers)
            {
        ...
        public void OnPost()
        {
            ...
            {
                BikeShop.DAL.Invoice invoice = new DAL.Invoice();
