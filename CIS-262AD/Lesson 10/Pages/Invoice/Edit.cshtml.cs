...
namespace Lesson_10.Pages.Invoice
{
    public class EditModel : PageModel
    {
        ...
        public void OnGet(int id = 0)
        {
            ...
            Lesson_10.DAL.Invoice invoice = _invoiceAdapater.GetInvoiceById(id);
            if(invoice != null)
            {
        ...
        public void SetupCustomerOptions()
        {
            ...
            IEnumerable<Lesson_10.DAL.Customer> customers = _customerAdapater.GetAllCustomers();
            foreach(Lesson_10.DAL.Customer customer in customers)
            {
        ...
        public void OnPost()
        {
            ...
            {
                Lesson_10.DAL.Invoice invoice = new DAL.Invoice();
